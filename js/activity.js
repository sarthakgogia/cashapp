...
(function( $ )
	...
	var Resources =["<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $25</span>",
					"<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $50</span>",
					"<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $75</span>",
					"<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $75</span>",
					"<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $100</span>",
					"<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $100</span>",
					"<span class='recent-activity-r-item-1'><span class='recent-activity-prepend'>Generated</span> $100</span>"];	
	$(document).ready(function() { 
	$.sticky('<div class="recent-activity-tab"><div class="recent-activity-user-wrapper"><img class="r-a-user-icon" src="img/input-icon.png"/><span class="activity-username">' + random_username() +'</span></div><div class="activity-generated-amount">'+random_amount() +'</div><div class="recent-activity-progress-wrapper"></div>');
